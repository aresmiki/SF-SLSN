function [optW,rec,funv,Info]=min_lplq(x,np,option,p,q)
 % Blind deconvolution based on G-lplq norm
    ...
    %
    %    Algorithm Reference:
    %    [1] Optimized minimum generalized Lp/Lq deconvolution for recovering repetitive 
    %    impacts from a vibration mixture, Measurement, vol. 168，
    %     https://doi.org/10.1016/j.measurement.2020.108329 
    %
    %   [2] Sparse filtering with the generalized lp/lq norm and its applications to the condition 
    %   monitoring of rotating machinery, Mech. Syst. Signal Process. 102 (2018) 198?213. 
